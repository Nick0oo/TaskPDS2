...
const resolver = mergeResolvers([ userResolvers, tasksResolvers, commentResolvers, projectResolvers, subtaskResolvers, statusResolvers, prioritiesResolvers, tagsResolvers ]);
